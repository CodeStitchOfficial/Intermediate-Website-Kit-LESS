...
// imports
var pluginEleventyNavigation = require("@11ty/eleventy-navigation"); // const pluginMinifier = require("@sherby/eleventy-plugin-files-minifier");


var pluginSitemap = require("@quasibit/eleventy-plugin-sitemap");

var configCssExtension = require("./src/config/cssExtension");

var configSitemap = require("./src/config/sitemap");

var configServer = require("./src/config/server");

var filterPostDate = require("./src/config/postDate");
...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addExtension("css", configCssExtension); // END EXTENSIONS
  ...
  eleventyConfig.addPlugin(pluginEleventyNavigation); // Automatically generate a sitemap, using the domain in _data/client.json
  // https://www.npmjs.com/package/@quasibit/eleventy-plugin-sitemap

  eleventyConfig.addPlugin(pluginSitemap, configSitemap); // When in production ("npm run build" is ran), minify all HTML, CSS, JSON, XML, XSL and webmanifest files.
  ...
  eleventyConfig.setServerOptions(configServer); // END SERVER
  ...
  eleventyConfig.addPassthroughCopy("./src/assets/js"); // Other required folders are passed through
  ...
  eleventyConfig.addFilter("postDate", filterPostDate); // END FILTERS
